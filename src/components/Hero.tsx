...
import { Shield, Code2, Rocket, Terminal, Lock, Globe, ChevronDown, ExternalLink } from "lucide-react";
...
const BentoCard = ({ children, className = "", delay = 0, hover = true }: BentoCardProps) => {
            ...
            <div className="flex flex-col h-full">
              <div className="flex items-start gap-5 mb-6">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <h1 className={`text-3xl lg:text-4xl font-bold mb-1 ${isDark ? "text-white" : "text-gray-900"}`}>
                    Hafiz Khuram
                  </h1>
              ...
              <p className={`text-base lg:text-lg leading-relaxed mb-6 ${isDark ? "text-gray-400" : "text-gray-600"}`}>
                Building secure, scalable web applications and privacy-focused tools.
                Creator of <a href="https://trustscan.dev" target="_blank" rel="noopener noreferrer" className="text-primary-500 hover:text-primary-400 transition-colors inline-flex items-center gap-1">TrustScan.dev <ExternalLink className="w-3 h-3" /></a> —
                a free privacy compliance platform trusted by businesses worldwide.
              </p>
          ...
          <BentoCard className="lg:col-span-1" delay={0.15}>
            <div className="flex flex-col h-full">
              <div className={`w-12 h-12 rounded-2xl flex items-center justify-center mb-4
                ...
                <Code2 className={`w-6 h-6 ${isDark ? "text-violet-400" : "text-violet-600"}`} />
              </div>
              <h3 className={`text-lg font-semibold mb-2 ${isDark ? "text-white" : "text-gray-900"}`}>
                Full Stack
              </h3>
              ...
              <div className="mt-auto pt-4">
                <span className={`text-3xl font-bold ${isDark ? "text-violet-400" : "text-violet-600"}`}>
          ...
          <BentoCard className="md:col-span-2" delay={0.2}>
            <div className="flex items-center gap-4">
              <div className={`w-14 h-14 rounded-2xl flex items-center justify-center shrink-0
                ...
                <Lock className={`w-7 h-7 ${isDark ? "text-primary-400" : "text-primary-600"}`} />
              </div>
              <div className="flex-1 min-w-0">
                ...
                <p className={`text-sm ${isDark ? "text-gray-400" : "text-gray-600"}`}>
                  Free privacy compliance platform — 8 tools, 100% client-side, zero data collection
                </p>
              </div>
              <a
          ...
          <BentoCard className="lg:col-span-1" delay={0.25} hover={false}>
            <div className="flex flex-col h-full">
              <div className="flex items-center gap-3 mb-4">
                <Terminal className={`w-5 h-5 ${isDark ? "text-primary-400" : "text-primary-600"}`} />
                <span className={`text-sm font-medium ${isDark ? "text-gray-300" : "text-gray-700"}`}>
                  Tech Stack
                </span>
              </div>
              <div className="flex flex-wrap gap-2">
                {["React", "TypeScript", "Node.js", "Python", "AWS", "Wazuh"].map((tech, i) => (
                  <motion.span
                    key={tech}
          ...
          <BentoCard className="lg:col-span-1" delay={0.3}>
            <div className="flex items-center gap-4">
              <div className={`w-12 h-12 rounded-2xl flex items-center justify-center
                ...
                <Globe className={`w-6 h-6 ${isDark ? "text-rose-400" : "text-rose-600"}`} />
              </div>
              <div>
                <p className={`text-sm ${isDark ? "text-gray-400" : "text-gray-500"}`}>Based in</p>
                <p className={`font-semibold ${isDark ? "text-white" : "text-gray-900"}`}>Helsinki, Finland</p>
              </div>
            </div>
          </BentoCard>

          {/* Social Links Card */}
          <BentoCard className="md:col-span-2 lg:col-span-2" delay={0.35} hover={false}>
