    ...
    >
      <div className="flex items-center gap-3">
        ...
        <div className="min-w-0">
          ...
          <p
            className={`text-sm font-medium ${isDark ? "text-white group-hover:text-primary-400" : "text-gray-900 group-hover:text-primary-600"} transition-colors break-all`}
          >
            {value}
          </p>
        </div>
...
function Contact() {
  ...
  return (
    ...
    >
      ...
      <GradientOrb
        className={`w-96 h-96 -top-48 -left-48 ${isDark ? "bg-primary-500/20" : "bg-primary-500/10"}`}
      />
      <GradientOrb
        className={`w-96 h-96 -bottom-48 -right-48 ${isDark ? "bg-violet-500/20" : "bg-violet-500/10"}`}
      />
          ...
          >
            <div className="flex items-center gap-3 mb-4">
              <div className="relative">
                <div
                  className={`w-3 h-3 rounded-full ${isDark ? "bg-green-400" : "bg-green-500"}`}
                />
                <div
                  className={`absolute inset-0 w-3 h-3 rounded-full ${isDark ? "bg-green-400" : "bg-green-500"} animate-ping`}
                />
              </div>
              <span
